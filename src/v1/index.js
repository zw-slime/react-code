...
class App extends React.Component {
    render() {
        return createElement('div',null,
            createElement('ui',null,stories.map(stroy => {
                return createElement(Story,{name:stroy.name,url:stroy.url})
            }))
        )
    }
}
...
class Story extends React.Component {
    ...
    render() {
        ...
        return  createElement('li',null,
            createElement('button',{onClick:()=> _this.like()},likes,
                createElement('b',null,"\u2764\uFE0F"),
            ),
            createElement('a',{href: url},name),
        )
...
React.render(createElement(App,{stories}),document.getElementById("root"))
